...
Sidebar.propTypes = {
  ...
  collapsible: PropTypes.oneOfType([
    PropTypes.oneOf(["none", "offcanvas", "icon"]),
    PropTypes.shape({
      base: PropTypes.oneOf(["none", "offcanvas", "icon"]),
      sm: PropTypes.oneOf(["none", "offcanvas", "icon"]),
      md: PropTypes.oneOf(["none", "offcanvas", "icon"]),
      lg: PropTypes.oneOf(["none", "offcanvas", "icon"]),
      xl: PropTypes.oneOf(["none", "offcanvas", "icon"]),
      "2xl": PropTypes.oneOf(["none", "offcanvas", "icon"]),
    }),
  ]),
  className: PropTypes.string,
  children: PropTypes.node,
